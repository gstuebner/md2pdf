#!/usr/bin/env bash
# Generates internal/assets/theme/fonts.css from the woff2 files in internal/assets/fonts/.
set -euo pipefail
cd "$(dirname "$0")/.."
...
{
  printf '/* Generated by scripts/genfonts.sh — do not edit by hand.\n'
  printf '   Inter, Source Serif 4 and JetBrains Mono, SIL Open Font License 1.1.\n'
  printf '   Licence texts: internal/assets/fonts/OFL-*.txt */\n\n'
  ...
  face "Source Serif 4" normal "$LATIN"    source-serif-4-latin-wght-normal.woff2
  face "Source Serif 4" italic "$LATIN"    source-serif-4-latin-wght-italic.woff2
